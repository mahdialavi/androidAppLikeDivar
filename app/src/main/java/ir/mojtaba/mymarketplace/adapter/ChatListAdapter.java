...
import ir.mojtaba.mymarketplace.PhotoViewActivity;
...
import ir.mojtaba.mymarketplace.model.ChatItem;
import ir.mojtaba.mymarketplace.view.ResizableImageView;
...
public class ChatListAdapter extends BaseAdapter implements Constants {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.mLeft_TimeAgo.setTypeface(tf);
			...
			viewHolder.mRight_TimeAgo.setTypeface(tf);
