...
import ir.mojtaba.mymarketplace.model.Chat;
...
public class DialogListAdapter extends BaseAdapter implements Constants {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.chatOpponentFullname.setTypeface(tf);
			viewHolder.chatLastMessageAgo.setTypeface(tf);
			viewHolder.chatNewMessagesCount.setTypeface(tf);
