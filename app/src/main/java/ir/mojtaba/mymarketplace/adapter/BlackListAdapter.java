...
import ir.mojtaba.mymarketplace.model.BlacklistItem;
import ir.mojtaba.mymarketplace.util.BlacklistItemInterface;
...
public class BlackListAdapter extends BaseAdapter implements Constants {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.mBlockedUserFullname.setTypeface(tf);    
			viewHolder.mBlockedReason.setTypeface(tf);
			viewHolder.mBlockedTimeAgo.setTypeface(tf);
