...
import ir.mojtaba.mymarketplace.util.Helper;
...
public class SignupFragment extends Fragment implements Constants {
    ...
    EditText signupUsername, signupFullname, signupPassword, signupEmail, signupPhone;
    Button signupJoinHowBtn;
    
	TextView mLabelTerms, mRegularSignup, mLabelAuthorizationViaFacebook, mSigninButton;

    private String username, password, email, language, fullname, phone;
                                        ...
                                        if (App.getInstance().authorize(response)) {
                                            ...
                                            switch (App.getInstance().getErrorCode()) {
                                                ...
                                                case 303 : {
                                                    ...
                                                    signupPhone.setError(getString(R.string.error_phone_taken));
                                                    break;
                                                }
...
//            getNotifications();
    ...
    public Boolean checkPhone() {
        ...
        if (phone.length() == 0) {
            ...
            signupPhone.setError(getString(R.string.error_field_empty));
        ...
        if (!helper.isValidPhone(phone)) {
            ...
            signupPhone.setError(getString(R.string.error_wrong_format));
