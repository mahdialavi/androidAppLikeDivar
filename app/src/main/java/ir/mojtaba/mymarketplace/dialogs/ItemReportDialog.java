...
public class ItemReportDialog extends DialogFragment implements Constants {
    ...
    public interface AlertPositiveListener {
        ...
        public void onItemReport(int position, int reason);
    }
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onItemReport(position, reason);
        }
    };
